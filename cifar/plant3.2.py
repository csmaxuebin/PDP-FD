...
# 加载数据
with open('plant_data/dp5-fedkd18-83.56.txt', 'r') as f1:
    data1 = f1.readlines()  # 加载第一个文件的数据

with open('plant_data/pj-dp5-fedkd18-82.2475.txt', 'r') as f2:
    data2 = f2.readlines()  # 加载第二个文件的数据

with open('plant_data/dddj-fedkd18-dp5-81.0425.txt', 'r') as f3:
...
# 绘制每个文件的准确率数据
# plt.plot(rounds, acc1, color='#73BCD5', linestyle='-', marker='*', markevery=10, label='PDP-FD (ε=5)')
# plt.plot(rounds, acc2, color='#FFD06E', linestyle='-', marker='p', markevery=10, label='DP-FD (ε=5,Fixed)')
# plt.plot(rounds, acc3, color='#ef8a46', linestyle='-', marker='s', markevery=10, label='DP-FD (ε=5,Uniform)')
