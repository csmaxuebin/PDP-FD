...
# 加载数据
with open('plant_data/fedkd18-87.1025.txt', 'r') as f1:
    data1 = f1.readlines()  # 加载第一个文件的数据

with open('plant_data/fedkd18-dy1-78.71.txt', 'r') as f2:
    data2 = f2.readlines()  # 加载第二个文件的数据

with open('plant_data/fedkd18-dy2-81.8975.txt', 'r') as f3:
    data3 = f3.readlines()  # 加载第三个文件的数据

with open('plant_data/fedkd18-dy3-82.635.txt', 'r') as f4:
    data4 = f4.readlines()  # 加载第四个文件的数据

with open('plant_data/fedkd18-dy4-84.02.txt', 'r') as f5:
