...
# 加载数据
with open('plant_data/ysys/DP-FedKD34-NO-3.txt', 'r') as f1:
    data1 = f1.readlines()  # 加载第一个文件的数据

with open('plant_data/ysys/DP-FedKD34-ye-3.txt', 'r') as f2:
    data2 = f2.readlines()  # 加载第二个文件的数据

with open('plant_data/ysys/DP-FedPer34-ye-3.txt', 'r') as f3:
    data3 = f3.readlines()  # 加载第三个文件的数据

with open('plant_data/ysys/DP-LG-Fed34-ye-3.txt', 'r') as f4:
