...
# 加载数据
with open('plant_data/dp2-fedkd34-74.91.txt', 'r') as f1:
    data1 = f1.readlines()  # 加载第一个文件的数据

with open('plant_data/pj-dp2-fedkd34-71.3925.txt', 'r') as f2:
    data2 = f2.readlines()  # 加载第二个文件的数据

with open('plant_data/dddj-fedkd34-dp2-72.5775.txt', 'r') as f3:
